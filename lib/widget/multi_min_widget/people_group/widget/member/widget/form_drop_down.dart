            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                ...
                items: widget.items.keys.map((String value) {
                  if(widget.items[value] is Person){
                    return DropdownMenuItem<String>(
                      value: value,
                      child: Row(
                        children: [
                          Icon(FeatherIcons.user ,color: (widget.items[value] as Person).type == 3 ? AppTheme.colorBox('meeting_color_four'):AppTheme.colorBox('meeting_color_seven'),),
                          Text(
                            value,
